        ...
        Surface(
            ...
            Column(
                ...
                Row(
                    ...
                    TextButton(
                        onClick = {
                            checkedIds = if (checkedIds.size == mobiFiles.size) {
                                emptySet()
                            } else {
                                mobiFiles.map { it.id }.toSet()
                            }
                        },
                    ) {
                        Text(if (checkedIds.size == mobiFiles.size) "Deselect all" else "Select all")
                    }
                }
